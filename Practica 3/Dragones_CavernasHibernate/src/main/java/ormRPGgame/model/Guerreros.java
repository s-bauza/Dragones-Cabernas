...
public class Guerreros {
    ...
    public boolean equals(Object o) {
        ...
        if (nombre != null ? !nombre.equals(guerreros.nombre) : guerreros.nombre != null) return false;
        if (jugadorId != null ? !jugadorId.equals(guerreros.jugadorId) : guerreros.jugadorId != null) return false;
        if (dagaId != null ? !dagaId.equals(guerreros.dagaId) : guerreros.dagaId != null) return false;
        if (vida != null ? !vida.equals(guerreros.vida) : guerreros.vida != null) return false;
        if (nivel != null ? !nivel.equals(guerreros.nivel) : guerreros.nivel != null) return false;
        if (oro != null ? !oro.equals(guerreros.oro) : guerreros.oro != null) return false;
        if (mana != null ? !mana.equals(guerreros.mana) : guerreros.mana != null) return false;
        if (apariencia != null ? !apariencia.equals(guerreros.apariencia) : guerreros.apariencia != null) return false;
        if (fuerza != null ? !fuerza.equals(guerreros.fuerza) : guerreros.fuerza != null) return false;
